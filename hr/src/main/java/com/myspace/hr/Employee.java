...
public class Employee implements java.io.Serializable {
  ...
  static final long serialVersionUID = 1L;
	...
	private com.myspace.hr.Address address;
	...
	public com.myspace.hr.Address getAddress() {
		return this.address;
	}

	public void setAddress(com.myspace.hr.Address address) {
	...
	public Employee(java.lang.String firstName, java.lang.String lastName,
			...
			com.myspace.hr.Address address) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.personalId = personalId;
		this.birthDate = birthDate;
